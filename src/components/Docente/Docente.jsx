    ...
    return(
        <div className="container pt-5 pb-5">
            ...
            <div className="d-flex align-items-center justify-content-around pt-5">
                <div className="col-5">
            <p className=" text-secondary pb-3"><h2 className="texto-marron mb-4"><b>Equipo docente</b></h2>Todo nuestro personal cuenta con eltítulo de Maestro de Educación
